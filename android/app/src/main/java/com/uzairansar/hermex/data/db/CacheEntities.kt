...
data class CachedSessionEntity(
    ...
    fun toSummary(): SessionSummary = SessionSummary(
        ...
        compressionTipArchived = compressionTipArchived,
        compressionArchiveCheckedAt = compressionArchiveCheckedAt,
    ...
    companion object {
        ...
        fun from(serverUrl: String, session: SessionSummary, now: Long = System.currentTimeMillis()): CachedSessionEntity? {
            ...
            return CachedSessionEntity(
                ...
                compressionTipArchived = session.compressionTipArchived,
                compressionArchiveCheckedAt = session.compressionArchiveCheckedAt,
